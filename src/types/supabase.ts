  ...
  public: {
    Tables: {
      ...
      bookings: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["occurrence_id"]
            isOneToOne: false
            referencedRelation: "v_occurrence_map"
      ...
      self_hosted_slots: {
        ...
        Relationships: [
          {
            foreignKeyName: "self_hosted_slots_self_location_id_fkey"
            columns: ["self_location_id"]
            isOneToOne: false
            referencedRelation: "self_hosted_locations"
            referencedColumns: ["id"]
          },
        ]
      }
      session_occurrences: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_occurrences_self_hosted_slot_id_fkey"
            columns: ["self_hosted_slot_id"]
            isOneToOne: false
            referencedRelation: "self_hosted_slots"
            referencedColumns: ["id"]
          },
          {
          ...
          {
            foreignKeyName: "session_occurrences_studio_slot_id_fkey"
            columns: ["studio_slot_id"]
            isOneToOne: false
      ...
      sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sessions_studio_fk"
            columns: ["studio_location_id"]
            isOneToOne: false
      ...
      studio_slots: {
        ...
        Relationships: [
          {
            foreignKeyName: "studio_slots_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "studio_locations"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      claim_invite: {
        ...
        Returns: {
          invite_role: Database["public"]["Enums"]["role_type"]
          ok: boolean
        }[]
      }
    ...
    Enums: {
      ...
      payment_status: "none" | "reserved" | "paid" | "refunded"
      role_type: "athlete" | "motionExpert" | "studioHost" | "admin"
      session_type: "private" | "group" | "trainWithMe"
      slot_status: "available" | "held" | "booked" | "blocked" | "archived"
