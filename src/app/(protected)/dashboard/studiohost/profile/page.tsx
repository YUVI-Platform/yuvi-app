...
export default function ProfilePage() {
  return (
    <div className="min-h-[100svh] bg-[radial-gradient(1200px_600px_at_50%_-200px,rgba(99,102,241,0.15),transparent),radial-gradient(800px_400px_at_80%_120%,rgba(244,63,94,0.12),transparent)] p-4 sm:p-6">
...
function MemberCard() {
  ...
  if (loading) {
    return (
      <div className="rounded-3xl bg-white/60 p-6 shadow-xl backdrop-blur ring-1 ring-black/5">
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <div className="rounded-[20px] bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 p-4 sm:p-5 ring-1 ring-white/10">
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <button
              onClick={() => setEdit((v) => !v)}
              className="ml-auto rounded-lg p-2 text-white/60 hover:bg-white/10 hover:text-white"
      ...
      <p className="text-center text-xs text-slate-600">
        Tipp: Halte die Karte gedrückt oder bewege den Finger – sie neigt sich
        leicht und glänzt ✨
      </p>
